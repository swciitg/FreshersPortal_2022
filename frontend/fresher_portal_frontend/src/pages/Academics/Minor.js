        ...
        <div className='page'>
            <div className="container">
                <div className='heading'>
                    ...
                    <p className='academics_heading-text'>B.Tech</p>
                </div>
                <div className='academics_description'>
                    <div className='academics_description-heading'>Students may opt for a Minor in a discipline other than the discipline he/she is registered in. Students completing a minor will have the minor mentioned in the degree certificate and in the final grade card.
...
A student with only minor courses remaining as backlogs at the beginning of a semester (other than a Summer semester) will be deemed to have completed the B. Tech. programme and he/she will be awarded a B.Tech degree without a minor.</div>
                </div>
            </div>
            <div className='container'>
                <div className='heading'>
                    <div className='academics_pre-cursor'></div>
                    <p className='academics_heading-text'>B.Des</p>
                </div>
                <div className='academics_description'>
                    <div className='academics_description-heading'>
