...
const descs = ["Guest House of IIT Guwahati is a piece of art and is used to accommodate invitees, important personalities and guardians of students of the institute. It contains 60 rooms, and with new guesthouse on the verge of completion to increase the number of rooms available for guests to over 217. Guest House offers rooms with modern facilities, mesmerizing landscape, Internet access and excellent dining that will turn anyone starving.",
  ...
  return (
    <Card sx={{ maxWidth: 600 }}>
      <CardMedia
        ...
        width="375px"
        margin="10px"
        image={`/assets/images/${String(props.title).split(' ')[0].toLowerCase()}.jpg`}
      />
      <CardContent>
